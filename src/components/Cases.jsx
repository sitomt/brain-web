...
const cases = [
  {
    ...
    logo: baktunLogo,
    logoWhite: false,
    alt: 'Baktun 13 — centro deportivo que digitalizó su operación con IA de Sito Labs',
    statValue: '14 h/sem',
  ...
  },
  {
    ...
    logo: clesolLogo,
    logoWhite: true,
    alt: 'Clesol — empresa solar que automatizó la clasificación de leads con Sito Labs',
    statValue: '+32%',
